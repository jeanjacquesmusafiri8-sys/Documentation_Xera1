# Migration vers l'API Buffer.from/Buffer.alloc
...
### Trouver les portions de code problématiques avec grep
...
### Trouver les portions de code problématiques avec Node.js 8
...
### Trouver les portions de code problématiques avec des linters
...
## Variante 1: abandonner la prise en charge de Node.js ≤ 4.4.x et 5.0.0 — 5.9.x
...
## Variante 2: utiliser un polyfill
...
## Variante 3 — détection manuelle avec protections
...
## À propos de Buffer.allocUnsafe
...
### Quel est le problème du constructeur `Buffer`?
